...
export const HomeIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955a1.5 1.5 0 012.122 0l8.954 8.955M3 13.5V21a1.5 1.5 0 001.5 1.5h15A1.5 1.5 0 0021 21v-7.5M10.5 22.5V15a1.5 1.5 0 011.5-1.5h0A1.5 1.5 0 0113.5 15v7.5" />
  </svg>
);

export const FolderIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 9.75h16.5m-16.5 0A2.25 2.25 0 016 7.5h12a2.25 2.25 0 012.25 2.25m-16.5 0v6.75A2.25 2.25 0 006 18.75h12a2.25 2.25 0 002.25-2.25V9.75" />
  </svg>
);
...
export const CogIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.007 1.11-1.227l.983-.393a1.5 1.5 0 011.11 0l.983.393c.55.22.98.685 1.11 1.227l.128.513a1.5 1.5 0 001.11.983l.513.128c.542.09.98.56 1.227 1.11l.393.983a1.5 1.5 0 010 1.11l-.393.983c-.22.55-.685.98-1.227 1.11l-.513.128a1.5 1.5 0 00-.983 1.11l-.128.513c-.09.542-.56.98-1.11 1.227l-.983.393a1.5 1.5 0 01-1.11 0l-.983-.393c-.55-.22-1.007-.685-1.227-1.11l-.128-.513a1.5 1.5 0 00-1.11-.983l-.513-.128c-.542-.09-.98-.56-1.227-1.11l-.393-.983a1.5 1.5 0 010-1.11l.393-.983c.22-.55.685-1.007 1.11-1.227l.513-.128a1.5 1.5 0 00.983-1.11l.128-.513z" />
